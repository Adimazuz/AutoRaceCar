...
void RealSense::setupColorImage(rs2_format format, RealSense::rs2ColorRessolution ressolution, RealSense::rs2fps fps)
{
    ...
    _config.enable_stream(RS2_STREAM_COLOR,w,h, format, freq);
}
